...
function sunPhrase(num) {
  switch (num) {
    ...
    default: {
      return 'There is a blood moon-- the end is nigh'
    }
  }
}
...
function InputSummary(props) {
  return (
    <div className="input-summary">
      <p>
        You got {props.input.sleep} hours of sleep last night. Your planned day
        involves {props.input.meals} meals and{' '}
        ...
        {props.input.social === 'Usual amount'
          ? 'your usual amount'
          : props.input.social.toLowerCase()}. {sunPhrase(props.input.sun)}, and{' '}
        {workPhrase(props.input.work)}
      </p>
    </div>
  )
}
